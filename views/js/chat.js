...
// API configuration
const API_URL = `https://restapii.rioooxdzz.web.id/api/gemini?message=`;
...
const generateAPIResponse = async (incomingMessageDiv) => {
  ...
  try {
    ...
    const apiResponse = data.data.response.replace(/\*\*(.*?)\*\*/g, '$1');
...
const showLoadingAnimation = () => {
  const html = `<div class="message-content">
                  <img class="avatar" src="https://pomf2.lain.la/f/rm98p7vp.jpg" alt="Gemini Avatar">
                  <p class="text"></p>
